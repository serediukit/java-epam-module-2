...
public class Collecting {
    ...
    public Collecting() {
        marksMapping.put((Double) -> Double > 90.0, "A");
        marksMapping.put((Double) -> Double < 90.0 && Double >= 83.0, "B");
        marksMapping.put((Double) -> Double < 83.0 && Double >= 75.0, "C");
        marksMapping.put((Double) -> Double < 75.0 && Double >= 68.0, "D");
        marksMapping.put((Double) -> Double < 68.0 && Double >= 60.0, "E");
        marksMapping.put((Double) -> Double < 60.0, "F");
    }
    ...
    private String getMark(Double Double) {
        return marksMapping.entrySet().stream()
                .filter(entry -> entry.getKey().test(Double))
